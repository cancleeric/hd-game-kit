...
export interface GameDefinition<G> {
     ...
     */
    enumerate?(match: MatchState<G>, moveId: string, playerId: number): readonly unknown[];
}
/**
 ...
 * @typeParam G - the game-specific state shape.
 */
export type EnumerateFn<G> = (match: MatchState<G>, moveId: string, playerId: number) => readonly unknown[];
/**
