 ...
 */
import type { GameDefinition, MatchState, MoveRecord } from './types.js';
/**
 ...
 */
export declare function replayMatch<G>(def: GameDefinition<G>, log: readonly MoveRecord[], numPlayers?: number): MatchState<G>[];
